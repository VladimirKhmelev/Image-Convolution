...
object GpuContext {
    ...
    private fun init() {
        ...
        try {
            ...
            val deviceName = String(nameBytes, 0, (nameSize[0] - 1).toInt().coerceAtLeast(0))
            ...
            val queue   = clCreateCommandQueue(context, chosenDevice, 0, null)
            ...
            val kernel = clCreateKernel(program, "convolve", null)
